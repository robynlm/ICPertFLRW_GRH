...
module TensorCalc_GRH

  implicit none
  contains

    ! The following subroutine computes A^{i}_{j} = g^{ik} A_{kj}
    subroutine ICPertFLRW_GRH_raise_one_indice ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
    ...
    end subroutine ICPertFLRW_GRH_raise_one_indice

    ! The following subroutine computes A^{ij} = g^{ik} g^{jl} A_{kl}
    subroutine ICPertFLRW_GRH_raise_two_indices ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
                                              Axx, Axy, Axz, Ayy, Ayz, Azz, &
    ...
    end subroutine ICPertFLRW_GRH_raise_two_indices

    ! The following subroutine computes G^{ijk} = g^{il} g^{jm} g^{kn} G_{lmn}
    ! With G having the Christoffel symbols symmetries
    subroutine ICPertFLRW_GRH_raise_three_indices ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
    ...
    end subroutine ICPertFLRW_GRH_raise_three_indices

    ! The following subroutine computes A = g^{ij} A_{ij}
    subroutine ICPertFLRW_GRH_take_trace ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
    ...
    end subroutine ICPertFLRW_GRH_take_trace

    ! The following subroutine computes A = g^{ij} A_{ij}, and A_{ij} isn't symmetric
    subroutine ICPertFLRW_GRH_take_trace_notsym ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
    ...
    end subroutine ICPertFLRW_GRH_take_trace_notsym

    ! The following subroutine computes A^{ij}A_{ij}
    subroutine ICPertFLRW_GRH_contract_over_two_indices ( Axx, Axy, Axz, Ayy, Ayz, Azz, &
                                                      Axxu, Axyu, Axzu, Ayyu, Ayzu, Azzu, &
                                                      AijuAijd )
      ! Input
      CCTK_REAL :: Axx, Axy, Axz, Ayy, Ayz, Azz
    ...
    end subroutine ICPertFLRW_GRH_contract_over_two_indices

    ! The following subroutine computes g^{ij}G_{imj}
    subroutine ICPertFLRW_GRH_Christoffel_contraction_one ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
                                                        Gxxx, Gxxy, Gxxz, Gxyy, Gxyz, Gxzz, &
                                                        Gyxx, Gyxy, Gyxz, Gyyy, Gyyz, Gyzz, &
                                                        Gzxx, Gzxy, Gzxz, Gzyy, Gzyz, Gzzz, &
                                                        Gnxn, Gnyn, Gnzn )
    ...
    end subroutine ICPertFLRW_GRH_Christoffel_contraction_one

    ! The following subroutine computes g^{ij}G_{mij}
    subroutine ICPertFLRW_GRH_Christoffel_contraction_two ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
                                                        Gxxx, Gxxy, Gxxz, Gxyy, Gxyz, Gxzz, &
                                                        Gyxx, Gyxy, Gyxz, Gyyy, Gyyz, Gyzz, &
                                                        Gzxx, Gzxy, Gzxz, Gzyy, Gzyz, Gzzz, &
                                                        Gxnn, Gynn, Gznn )
    ...
    end subroutine ICPertFLRW_GRH_Christoffel_contraction_two

    ! The following subroutine computes g^{ij}G_{mij}
    subroutine ICPertFLRW_GRH_Christoffel_contraction_three ( Gxxx, Gxxy, Gxxz, Gxyy, Gxyz, Gxzz, &
                                                          Gyxx, Gyxy, Gyxz, Gyyy, Gyyz, Gyzz, &
                                                          Gzxx, Gzxy, Gzxz, Gzyy, Gzyz, Gzzz, &
                                                          Gxxxu, Gxxyu, Gxxzu, Gxyyu, Gxyzu, Gxzzu, &
                                                          Gyxxu, Gyxyu, Gyxzu, Gyyyu, Gyyzu, Gyzzu, &
    ...
    end subroutine ICPertFLRW_GRH_Christoffel_contraction_three

    ! The following subroutine computes g^{ij}A_{i}B_{j}
    subroutine ICPertFLRW_GRH_product_of_two_vectors ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
                                                   Ax, Ay, Az, &
                                                   Bx, By, Bz, &
                                                   AB )
      ! Input
    ...
    end subroutine ICPertFLRW_GRH_product_of_two_vectors

    ! The following subroutine computes derivative of Gudd: \partial_{i}(g^{im} G_{mkl})
    subroutine ICPertFLRW_GRH_derivative_of_Gudd ( gxxu, gxyu, gxzu, gyyu, gyzu, gzzu, &
    ...
    end subroutine ICPertFLRW_GRH_derivative_of_Gudd

end module TensorCalc_GRH
